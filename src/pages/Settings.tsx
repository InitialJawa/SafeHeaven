...
export const Settings: React.FC = () => {
  ...
  const [rebalanceMode, setRebalanceMode] = useState('Dynamic');
  const [thresholdDev, setThresholdDev] = useState(5);
  ...
  useEffect(() => {
    if (portfolioConfig) {
      ...
      setRebalanceDays(portfolioConfig.rebalanceDays || 14);
      setRebalanceMode(portfolioConfig.rebalanceMode || 'Dynamic');
      setThresholdDev(portfolioConfig.thresholdDev || 5);
    }
